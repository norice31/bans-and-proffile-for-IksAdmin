...
if(!empty($settings['faceit_api_key'])){
  ...
  curl_setopt($nh, CURLOPT_URL, 'https://open.faceit.com/data/v4/players?game=cs2&game_player_id=' . $_POST['data']);
...
if(empty($data['games']['cs2']['skill_level'])){
  ...
  $return['skill_level'] = $General->arr_general['site'].'/app/modules/module_page_profiles/assets/img/faceit/'.$data['games']['cs2']['skill_level'].'.svg';
}
